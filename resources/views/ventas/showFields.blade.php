  ...
  <div class="card-body">
    <div class="container mb-5 mt-3">
      <div class="row d-flex align-items-baseline">
        <div class="col-xl-9">
        <p style="color: #7e8d9f;font-size: 20px;">VENTA <strong># {{ str_pad($venta->id, 4, '0', STR_PAD_LEFT) }} </strong></p>
        ...
        <div class="row">
          <div class="col-xl-8">
            <ul class="list-unstyled">
              <li class="text-muted">Cliente: <span style="color:#5d9fc5 ;"> {{$venta->user->name}} </span></li>
          ...
          <div class="col-xl-4">
            ...
            <ul class="list-unstyled">
              <li class="text-muted"><i class="fas fa-circle" style="color:#84B0CA ;"></i> <span
                  class="fw-bold">ID:</span> #{{ str_pad($venta->id, 4, '0', STR_PAD_LEFT) }}</li>
              <li class="text-muted"><i class="fas fa-circle" style="color:#84B0CA ;"></i> <span
                  class="fw-bold">Creation Date: </span> {{ $venta->created_at }}</li>
              <li class="text-muted"><i class="fas fa-circle" style="color:#84B0CA ;"></i> <span
                  class="me-1 fw-bold">Estado:</span><span class="badge bg-success text-white fw-bold">
                  {{ $venta->status }}</span></li>
            </ul>
          </div>
        </div>
    ...
    <table class="table table-striped table-borderless">
        ...
        <div class="row">
          ...
          <div class="col-xl-3">
            <ul class="list-unstyled">
              <li class="text-muted ms-3"><span class="text-black me-4">SubTotal</span>{{$venta->pago->monto_neto}}</li>
              <li class="text-muted ms-3 mt-2"><span class="text-black me-4">IVA(16%)</span>{{$venta->pago->impuestos}}</li>
            </ul>
            <p class="text-black float-start"><span class="text-black me-3"> Monto Total</span><span
                style="font-size: 25px;">{{$venta->pago->monto_total}}</span></p>
          </div>
        </div>
        <hr>
        <div class="row">
